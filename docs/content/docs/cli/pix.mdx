...
```bash
pix list --from 2026-03-01T00:00:00Z --to 2026-03-31T23:59:59Z
```
...
```bash
pix get E12345678901234567890123456
```
...
6. Transaction appears in `pix list`
```
